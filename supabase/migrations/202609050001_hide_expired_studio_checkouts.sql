-- Expired Stripe Checkout sessions were never purchases. Keep them out of the
-- Studio admin purchase feed while retaining open, failed and paid attempts.
...
comment on function public.admin_list_studio_checkouts(integer) is
  'Returns recent non-expired Studio Stripe checkouts to authenticated Timeless admins.';
